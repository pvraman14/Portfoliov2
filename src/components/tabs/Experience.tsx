        ...
        <div className="timeline">
            ...
            <div className="timeline-item">
                ...
                <div className="timeline-content">
                    ...
                    <section className="project">
                        <h3 className="project-title">AgenticAI – Platform to Create and Run Agents</h3>
            ...
            <div className="timeline-item">
                ...
                <div className="timeline-content">
                    ...
                    <section className="project">
                        <h3 className="project-title">Aera React Library – UI Library for Aera</h3>
                        <ul className="achievements">
                            <li>
                    ...
                    <section className="project">
                        <h3 className="project-title">Discovery – A Data Visualization Platform</h3>
                        <ul className="achievements">
                            <li>
